...
#include "widgets/settingspages/PointsPage.hpp"
...
void SettingsDialog::addTabs()
{
    ...
    this->addTab([]{return new PointsPage;},           "Points",         ":/settings/coin.png");
...
void SettingsDialog::selectTab(SettingsDialogTab *tab, bool byUser)
{
    ...
    tab->setStyleSheet(
        "background: #222; color: #efbb00;"  // Should this be same as accent color?
